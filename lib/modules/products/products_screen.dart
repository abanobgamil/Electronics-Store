...
class ProductsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        AppCubit.get(context).categoryProductModel = null;
        return true;
      },
      child: Scaffold(
        appBar: AppBar(
        ...
        body: BlocConsumer<AppCubit, AppStates>(
          ...
          builder: (context, state) {
            return ConditionalBuilder(
              condition: AppCubit.get(context).categoryProductModel != null,
              builder: (context) => productBuilder(
                  AppCubit.get(context).categoryProductModel!, context),
              fallback: (context) =>
  ...
  Widget productBuilder(CategoryProductModel model, context) =>
                        ...
                        IconButton(
                          onPressed: () {
                            AppCubit.get(context)
                                .changeCategoryFavorites(model.id);
                          },
                          icon: AppCubit.get(context)
                                  .categoryFavourites[model.id]!
                              ? const Icon(
                                  Icons.favorite,
                                  color: Colors.red,
                                )
